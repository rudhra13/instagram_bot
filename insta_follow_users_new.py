...
account_passwd = "arhdur0387_IG"
account_to_follow = "indianfoodyy"
...
# account_passwd = "arhdur0387_IG"
# account_to_follow = "memes4women"

# CREATE TABLE saint_insights_follow_attempt(
# first_follow_attempt_time TIMESTAMP,
...
# CREATE TABLE taste_with_bhukkad_follow_attempt(
# first_follow_attempt_time TIMESTAMP,
# account_name VARCHAR(500),
# user_name VARCHAR(500),
# status VARCHAR(50),
...
# CREATE TABLE memeworld_in_follow_attempt(
# first_follow_attempt_time TIMESTAMP,
# account_name VARCHAR(500),
# user_name VARCHAR(500),
# status VARCHAR(50),
...
def act_login(webdriver,user_name,passwd):
	...
	# button_login = webdriver.find_element_by_css_selector("body > div.RnEpo.Yx5HN > div > div > div > div.mt3GC > button.aOOlW.HoLwm")
	# button_login.click()
	# sleep(3)

# def account_db(query, query_type, connection):
	...
	while user_follow_attempt <= 3:
		if follow_user_button.text == 'Follow':
			...
			if user_follow_attempt >= 3:
				...
				row_count = account_db(connection, check_user_exists_query, "select")
				if row_count == 0:
